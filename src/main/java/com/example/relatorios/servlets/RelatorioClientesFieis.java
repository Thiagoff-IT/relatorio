 ...
 * @author razer
 */
@WebServlet(name = "RelatorioClientesFieis", urlPatterns = {"/RelatorioClientesFieis"})
public class RelatorioClientesFieis extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try(ConnectionFactory factory = new ConnectionFactory()) {
            ...
            String jasper = request.getContextPath() + "/ClientesFieis.jasper";
